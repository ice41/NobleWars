                                ...
                                <tr>
                                    <td width="50%" valign="top">
                                        ...
                                        <table class="vis" width="100%">
                                            <tr>
                                                <th colspan="2"
                                                     class="text-left" style="background-color: #c1a264; color: #000; padding: 3px;">
                                                ...
                                                <td colspan="2">
                                                    <form
                                                        ...
                                                        <?php if (isset($_GET['invite_x']) && isset($_GET['invite_y'])): ?>
                                                            ...
                                                            <div  class="p-10 bold" style="background-color: #ebdcae; border: 1px solid #aa7c11; border-radius: 4px; margin-bottom: 12px; color: #5d2f09; text-shadow: 0 0 10px rgba(212, 175, 55, 0.2);">
                                                                Convidar amigo para a posição: <?= (int)$_GET['invite_x'] ?>|<?= (int)$_GET['invite_y'] ?>
                                                            </div>
                                                        <?php endif; ?>

                                                        <!-- Seleção de tipo de convite -->
                                                        <div class="invite-type-selector mb-15 bold p-10"  style="display: flex; gap: 20px; background: #ebdcae; border-radius: 4px; border: 1px solid #7d510f;">
                                                            <label  class="pointer" style="display: flex; align-items: center; gap: 5px; color: #5d2f09;">
                                                            ...
                                                            <tr id="invite_username_row"  style="display: none;">
                                                                <td colspan="2">
                                                                    <?php if (empty($friends)): ?>
                                                                        <div  class="mb-10" style="background-color: #ebdcae; border: 1px solid #aa7c11; color: #5d2f09; padding: 8px; border-radius: 4px; width: 95%;">
                                                                    ...
                                                                    <?php else: ?>
                                                                        ...
                                                                        <select id="username_select"  class="p-5 mb-10" style="width: 95%; font-size: 14px; background: #fff; border: 1px solid #7d510f; border-radius: 4px;" onchange="syncUsernameInput(this.value)">
                                    ...
                                    <td width="50%" valign="top">
                                        ...
                                        <table class="vis text-center" width="100%" >
                                            <tr>
