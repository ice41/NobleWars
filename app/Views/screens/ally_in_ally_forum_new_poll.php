...
<form id="new_poll_form" method="post"
    ...
    <table width="100%" cellpadding="3" cellspacing="0">
        ...
        <tr>
            <td></td>
            <td>
                <a href="javascript:void(0)" onclick="addAnswerRow()"  class="bold" style="color:#a05000;">
        ...
        <tr>
            ...
            <td>
                <textarea name="content" id="poll_content_area" rows="10"
                     class="w-100" style="min-width:400px; border:1px solid #b0955a; padding:4px;"><?= htmlspecialchars($_POST['content'] ?? '') ?></textarea>
            </td>
        </tr>
    </table>
