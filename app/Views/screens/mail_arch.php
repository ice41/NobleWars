<?php if (!isset($message_id) || !is_numeric($message_id) || $message_id <= 0): ?>
    ...
    <div class="mail-container">
        ...
        <form action="game.php?village=<?= $village['id'] ?>&screen=mail&mode=arch&h=<?= $hkey ?>" method="post">
                        ...
                        <div class="mail-card">
                            ...
                            <div class="mail-content">
                                <div class="mail-header">
                                    <a href="game.php?village=<?= $village['id'] ?>&screen=mail&mode=arch&view=<?= $arr['id'] ?>"
                                        class="mail-subject">
                                ...
                                <?php if (!empty($arr['text'])): ?>
                                    <div class="mail-preview">
                                        <?= htmlspecialchars(mb_substr(strip_tags($arr['text']), 0, 100)) ?>
                                        <?= mb_strlen(strip_tags($arr['text'])) > 100 ? '...' : '' ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="mail-meta">
                                    <span>
                                        <?php if (isset($arr['from_username'])): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php elseif (isset($arr['to_username'])): ?>
                                            <?= __('screens.mail.to') ?>
                            ...
                            <div class="mail-actions">
                                <a href="game.php?village=<?= $village['id'] ?>&screen=mail&action=del&id=<?= $arr['id'] ?>&mode=arch&h=<?= $hkey ?>"
                                    class="mail-action-btn delete" title="<?= __('screens.mail.delete_button') ?>"
            ...
            <?php else: ?>
                <div class="mail-empty">
                    ...
                    <div class="mail-empty-text"><?= __('screens.mail.empty_archive') ?></div>
                </div>
            <?php endif; ?>
            ...
            <div class="mail-view">
                ...
                <div class="mail-view-actions">
                    <a href="game.php?village=<?= $village['id'] ?>&screen=mail&mode=<?= $mode ?>" class="mail-view-btn">
                        ← <?= __('screens.mail.back_to_archive') ?>
                    </a>
