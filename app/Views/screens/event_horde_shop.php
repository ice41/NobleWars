...
<div class="horde-shop-container">
    <div class="horde-shop-header">
        ...
        Disponível Guidons: <img src="graphic/events/ataque_horda/icon_currency.webp" width="16"  class="v-align-middle"> <b id="shop-guidons"><?= number_format($guidons, 0, ',', '.') ?></b><br><br>
        Os itens irão permanecer no inventário após o evento terminar.
    </div>

    <?php
    $shopItems = [
        ['id' => 3063, 'name' => 'Saqueador de bárbaros', 'img' => '3063.webp', 'desc' => 'Ataques enviados a aldeias bárbaras viajam mais rápido em 5%..<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 300],
        ['id' => 3003, 'name' => 'Sigilia de desespero', 'img' => '3003.webp', 'desc' => 'Apoio enviado enquanto ativo viajará 10% mais rápido.<br><br><span  class="text-green">Duração: 48:00:00<br>Aplicar a: Na aldeia</span>', 'cost' => 350],
        ['id' => 3069, 'name' => 'Booster de quartéis', 'img' => '3069.webp', 'desc' => 'Toda a velocidade de recrutamento em Quartel são 10% mais rápidos!<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 950],
        ['id' => 3072, 'name' => 'Bónus de estábulo', 'img' => '3072.webp', 'desc' => 'Toda a velocidade de recrutamento em Estábulo são 10% mais rápidos!<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 950],
        
        ['id' => 3058, 'name' => 'Bónus de construção', 'img' => '3058.webp', 'desc' => 'Todos os tempos de construção foram diminuídos em 15%!<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 1400],
        ['id' => 3018, 'name' => 'Booster de defensor', 'img' => '3018.webp', 'desc' => 'Lanceiro: +5% poder de defesa<br>Espadachim: +5% poder de defesa<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 1650],
        ['id' => 3016, 'name' => 'Booster de atacante', 'img' => '3016.webp', 'desc' => 'Viking: +5% poder do atacante<br>Cavalaria leve: +5% poder do atacante<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 1650],
        ['id' => 3066, 'name' => 'Booster de dano da catapulta', 'img' => '3066.webp', 'desc' => 'Catapulta: +25% Dano contra edifícios<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 1950],
        
        ['id' => 3042, 'name' => 'Recrutador', 'img' => '3042.webp', 'desc' => 'O recrutamento de unidades, incluindo nobres, é 5% mais rápido!<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 2300],
        ['id' => 3023, 'name' => 'Decreto nobre', 'img' => '3023.webp', 'desc' => '-10% Custo de moedas<br><br><span  class="text-green">Duração: 24:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 2300],
        ['id' => 3052, 'name' => 'Booster de cavalaria pesada', 'img' => '3052.webp', 'desc' => 'Cavalaria Pesada: +20% poder de defesa e ofensivo<br><br><span  class="text-green">Duração: 48:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 2800],
        ['id' => 3105, 'name' => 'Estratégias Ofensivas', 'img' => '3105.webp', 'desc' => 'Aumenta permanentemente o poder de ataque das unidades ofensivas em 2%.Pode acumular este efeito numa aldeia até 5 vezes.Viking: +2% poder do atacante Cavalaria leve: +2% poder do atacante.Arqueiro a cavalo: +2% poder do atacante<br><br><span  class="text-green">Aplicar a: Na aldeia</span>', 'cost' => 2800],
        ['id' => 3106, 'name' => 'Estratégias defensivas', 'img' => '3106.webp', 'desc' => 'Aumenta permanentemente o poder de defesa das unidades defensivas em 2%.Pode acumular este efeito numa aldeia até 5 vezes.Lanceiro: +2% poder de defesa. Espadachim: +2% poder de defesa. Arqueiro: +2% poder de defesa.<br><br><span  class="text-green">Duração: 48:00:00<br>Aplicar a: Na aldeia</span> ', 'cost' => 3106],
        ...
        ['id' => 3027, 'name' => 'Esforço de guerra', 'img' => '3027.webp', 'desc' => '+30% produção de recursos<br><br><span  class="text-green">Duração: 48:00:00<br>Aplicar a: Em todas as aldeias</span>', 'cost' => 3900],
        ...
        <?php foreach ($shopItems as $item): ?>
            <div class="horde-shop-item">
                ...
                <div class="horde-item-price">
                    <img src="graphic/events/ataque_horda/icon_currency.webp" width="16"  class="v-align-middle"> <?= number_format($item['cost'], 0, ',', '.') ?> Guidons
                </div>
