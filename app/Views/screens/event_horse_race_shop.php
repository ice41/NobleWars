...
<div class="horse-shop-container">
    <div class="horse-shop-header">
        ...
        Disponível Troféus: <img src="graphic/events/horse_race/icon_currency.webp" width="16"  class="v-align-middle"> <b id="shop-trophies"><?= number_format($trophies, 0, ',', '.') ?></b><br><br>
        ...
        <?php foreach ($shopItems as $item): ?>
            <div class="horse-shop-item">
                ...
                <div class="horse-item-price">
                    <img src="graphic/events/horse_race/icon_currency.webp" width="16"  class="v-align-middle"> <?= number_format($item['cost'], 0, ',', '.') ?> Troféus
                </div>
