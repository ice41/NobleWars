    ...
    <div class="event-header-top">
        <div class="shop-box-right">
            ...
            <div style="padding: 15px;">
                <img src="/graphic/events/ataque_horda/shop-chest.webp" style="width: 110px;" alt="">
        ...
        <img src="/graphic/events/ataque_horda/event_logo@2x.webp" style="float: left; width: 120px; margin-right: 20px;" alt="">
        ...
        <div style="display: flex; flex-direction: row; gap: 10px; margin-top: 20px;">
            <div class="bordered-box event-status" style="flex: 1; float: none; margin: 0;">
                ...
                <div class="status-value">
                    <img src="/graphic/events/ataque_horda/icon_energy.webp" style="height: 16px; vertical-align: middle; margin-right: 3px;" alt="">
                    <?= $energy ?> / <?= $max_energy ?>
            ...
            <div class="bordered-box event-status" style="flex: 1; float: none; margin: 0;">
                ...
                <div class="status-value">
                    <img src="/graphic/events/ataque_horda/icon_currency.webp" style="height: 16px; vertical-align: middle; margin-right: 3px;" alt="">
    ...
    <form action="game.php?village=<?= $village['id'] ?>&screen=event_horde&action=attack" method="POST">
        <div class="horde-battle-area">
            <div style="text-align: right; color: white; font-weight: bold; font-size: 18px; text-shadow: 2px 2px 3px black; padding: 20px;">
                <img src="/graphic/events/ataque_horda/icon_currency.webp" style="height: 24px; vertical-align: middle;" alt=""> <?= $guidons ?> <?= __('screens.event_horde.guidons') ?>
            </div>
        ...
        <div class="units-grid">
            <?php foreach ($event_units as $unit): ?>
                <div class="unit-choice" onclick="selectHordeUnit('<?= $unit['icon'] ?>', '<?= $unit['id'] ?>', '<?= $unit['name'] ?>')">
                    <img src="/graphic/events/ataque_horda/<?= $unit['icon'] ?>" alt="">
