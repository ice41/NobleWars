...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hof-table th.text-right,
        .hof-table td.text-right {
            text-align: right;
            padding-right: 0;
        }
                ...
                <div class="hof-grid">
                            ...
                            <table class="hof-table">
                                ...
                                <?php $pos = 1; foreach ($top_players as $player): ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><?= number_format($player['points'], 0, ',', '.') ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                        <?php else: ?>
                    ...
                    <div class="hof-card">
                        ...
                        <?php if (!empty($top_tribes)): ?>
                            <table class="hof-table">
                                <tr><th>Pos</th><th>Nome</th><th class="text-center">Membros</th><th class="text-right">Pontos</th></tr>
                                <?php $pos = 1; foreach ($top_tribes as $tribe): ?>
                                    <tr>
                                        <td><span class="hof-rank"><?= $pos++ ?></span></td>
                                        <td><a href="guest.php?world=<?= htmlspecialchars($world) ?>&screen=info_ally&id=<?= $tribe['id'] ?>"><?= htmlspecialchars($tribe['name']) ?> (<?= htmlspecialchars($tribe['tag']) ?>)</a></td>
                                        <td class="text-center"><?= number_format($tribe['members_count'], 0, ',', '.') ?></td>
                                        <td class="text-right"><?= number_format($tribe['points'], 0, ',', '.') ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                        <?php else: ?>
